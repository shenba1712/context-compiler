...
The live-task rail workspace is now the default and sole workspace chrome. `NEXT_PUBLIC_CC_WORKSPACE_REVAMP=1` remains documented for deploy environments created during the rollout; the legacy step-tab UI has been retired.
